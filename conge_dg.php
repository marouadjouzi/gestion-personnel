                ...
                <div>
                    ...
                    <div class="nav__list">
                       ...
                       <?php if($_SESSION['role'] == 'superadmin' || $_SESSION['role'] == 'admin'){?>
                        ...
                        <a href="conge_dg.php" class="nav__link active">
                                    <ion-icon name="calendar-outline" class="nav__icon"></ion-icon>
                                    <span class="nav__name">Congés</span>
                                </a>
                        <?php }}?>
            ...
            while ($row44 = mysqli_fetch_assoc($result44)) {
                ...
                while ($row444 = mysqli_fetch_assoc($result444)) {
                        if ($row4['type_conge'] == 'annuel detente' && $row4['val_direct_general'] == '0' && $row4['val1_rh']) {
                            ...
                            <table class="table-container"  >
                                ...
                                <tbody style="background-color: white;">
                                    <tr>
                                        ...
                                        <?php if ($row4['val_direct_general'] == "0") {
                                                ?>
                                                <form action="conge_dg.php" method="post"><td>
                            ...
                            <?php
                        } else if ($row4['type_conge'] == 'exceptionel' && $row4['val_direct_general'] == '0' && $row4['val1_rh'] == '1') {
                            ?>
                            <h2> Demandes des congés exceptionnel</h2>
                            <table class="table-container">
                                <thead>
                                    <tr>
                                        <th>ID_Employe</th>
    ...
    if (isset($_POST['id'])) {
        ...
        if ($selectedOption == 'oui') {
            ...
            if (isset($_POST['emp'])) {
                ...
                if (isset($_POST['type'])) {
                    $type = $_POST['type'];
                    $message = "Votre demande de conge " . $type . " est validee au niveau de direction generale";
                    ...
                    if ($row['count'] == 0) {
                        ...
                        $not_stmt->bindParam(':current_datetime', $current_datetime);
                        $not_stmt->execute();
                        echo "L'entrée a été insérée avec succès.";
                    }
                    $role = "superadmin";
                    ...
                    if ($employee44->rowCount() > 0) {
                        while ($line44 = $employee44->fetch(PDO::FETCH_ASSOC)) {
                            echo "<script>console.log(" . $id_receive2 . "," . $id_send . ")</script>";
                            $message2 = "Vous avez recu une demande de conge " . $type . " de " . $line44['nom'] . " " . $line44['prenom'] . " pour une validaion finale";
                            ...
                            if (!$not_stmt2->execute()) {
                                echo "Error: " . $not_stmt2->errorInfo()[2];
                ...
                if (isset($_POST['emp'])) {
                    ...
                    if (isset($_POST['type'])) {
                        $type = $_POST['type'];
                        $message = "Votre demande de conge " . $type . " est refusee au niveau de direction generale";
...
?>
                    <tr>
                        ...
                        <?php if ( $line4['val_direct_general'] == '1'  && $line4['val2_rh'] == '0') { ?> 
                            ...
                            <td>En attente</td>
                            <td style="background-color:#e6e8ed; border:none"><form method = "POST" action="conge_dg.php">
                        ...
                        <?php }else if ( $line4['val_direct_general'] == '2') { ?> 
...
if(isset($_POST['modifier'])) {
    ...
    if($id) {
        ...
        echo '<div id="confirmation_s" class="popup_v">
            <form id="confirmation-form" method="post" action="conge_dg.php">
